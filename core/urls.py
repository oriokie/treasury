...
from . import views
from . import intelligence_views as iv
...
urlpatterns = [
    ...
    path("settings/allocation-priority/", views.AllocationPriorityView.as_view(),
         name="allocation_priority"),
    path("settings/envelope-columns/", views.EnvelopeColumnsView.as_view(),
         name="envelope_columns"),
    ...
    path("workspace/", iv.TreasurerWorkspaceView.as_view(), name="treasurer_workspace"),
    path("workspace/insight-status/", iv.InsightStatusView.as_view(),
         name="insight_status"),
    path("api/analytics/insights/", iv.AnalyticsInsightsAPI.as_view(),
         name="api_analytics_insights"),
    path("api/analytics/health/", iv.AnalyticsHealthAPI.as_view(),
         name="api_analytics_health"),
    path("api/analytics/trend/", iv.AnalyticsTrendAPI.as_view(),
         name="api_analytics_trend"),
    path("api/analytics/knowledge/", iv.AnalyticsKnowledgeAPI.as_view(),
         name="api_analytics_knowledge"),
