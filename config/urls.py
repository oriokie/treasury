...
urlpatterns = [
    ...
    path("accounts/login/", login_not_required(TwoFactorLoginView.as_view()), name="login"),
    ...
    path("accounts/forgot-password/",
         login_not_required(self_reset_views.SelfPasswordResetRequestView.as_view()),
         name="self_reset_request"),
    path("accounts/forgot-password/verify/",
         login_not_required(self_reset_views.SelfPasswordResetVerifyView.as_view()),
    ...
    path("accounts/forgot-password/email/confirm/<uidb64>/<token>/",
         login_not_required(auth_views.PasswordResetConfirmView.as_view(
