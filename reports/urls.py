...
urlpatterns = [
    ...
    path("adoption/", admin_views.AdoptionDashboardView.as_view(),
    ...
    path("designer/<slug:key>/duplicate/",
         admin_views.DesignerDuplicateView.as_view(), name="designer_duplicate"),
    path("designer/<slug:key>/delete/", admin_views.DesignerDeleteView.as_view(),
         name="designer_delete"),
    path("schedules/", admin_views.ScheduleListView.as_view(), name="schedule_list"),
    path("schedules/<int:pk>/run/", admin_views.ScheduleRunView.as_view(),
         name="schedule_run"),
    path("schedules/<int:pk>/toggle/", admin_views.ScheduleToggleView.as_view(),
         name="schedule_toggle"),
    path("snapshots/", admin_views.SnapshotHistoryView.as_view(),
         name="snapshot_history"),
    path("snapshots/compare/<int:a>/<int:b>/",
         admin_views.SnapshotCompareView.as_view(), name="snapshot_compare"),
