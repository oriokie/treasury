...
urlpatterns = [
    ...
    path("pledges/<int:pk>/match-aliases/", views.PledgeMatchAliasAddView.as_view(),
         name="pledge_match_alias_add"),
    path("pledges/<int:pk>/match-aliases/<int:alias_id>/delete/",
         views.PledgeMatchAliasDeleteView.as_view(),
         name="pledge_match_alias_delete"),
