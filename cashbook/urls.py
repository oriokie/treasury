...
urlpatterns = [
    ...
    path("reports/fund/<int:pk>/budget/group-goals.png", views.GroupGoalsPngView.as_view(), name="group_goals_png"),
    path("reports/fund/<int:pk>/budget/items.png", views.BudgetItemsPngView.as_view(), name="budget_items_png"),
